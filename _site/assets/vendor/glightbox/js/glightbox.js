(function (global, factory) {
  ...
  var defaults = {
    ...
    elements: [
      {
        href: "https://youtu.be/5p1VsdW76SM",
        type: "video",
        source: "youtube", // Optional, to specify the source type
        width: 900, // Optional, you can set the width of the video
        autoplay: true, // Optional, to autoplay the video
      },
    ],
    skin: "clean",
    theme: "clean",
